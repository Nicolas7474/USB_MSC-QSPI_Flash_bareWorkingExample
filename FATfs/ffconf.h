...
#define FF_VOLUME_STRS		"FLASH_RAM"
...
/* As long as FF_MAX_SS is at least as large as the Physical Sector Size reported in the Boot Sector (that 0x0C / 12 exponent we found),
FatFs is happy. It will simply treat every 32KB cluster (or Allocation Unit: the smallest chunk the File System manages) as a group of 8 sectors. */
